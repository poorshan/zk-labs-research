---
layout: default
title: "CRCL (Circle) v2.4 — 从货币基金到金融互联网：完整财务模型与投资框架"
date: 2026-07-25
categories: research
author: 金戊乾坤2号
permalink: /research/2026/07/25/crcl-circle-v2.html
data_cutoff: 2026-07-25
version: "v2.4.2 (v2.4 研究生产体系升级 + WACC×g矩阵全格重算 + 非储备收入模型驱动关系诚实重述)"
---
...
|:--|:--|:--|:--|:--|
| 1 | **稳定币是 Commodity**<br>竞争拉低 Take Rate → 利润永久萎缩 | 稳定币之间功能高度同质化；<br>USAT 上线后无实质差异化 | 合规本身即差异化——GENIUS Act 将离岸发行商排除在银行体系之外；<br>「合规稳定币」的供给远小于需求 | USDC 市占率跌破 18% 连续两个季度 AND Take Rate 降至 5bps 以下——届时承认稳定币已 Commodity 化 |
...
| OUSD 联盟份额侵蚀 | Medium | High | USDC 市占率; OUSD 流通量 | USDC <18% |
...
## 附录：Thesis Scorecard — 投资论点仪表盘

> **v2.4 新增（Bernstein 式 Thesis Tracking）**：将投资论点从「一次性判断」升级为「可季度更新的追踪系统」。

| # | 论点维度 | 状态 | 上次更新 | 下次验证节点 | 验证方法 |
|:--|:--|:--|:--|:--|:--|
| 1 | Stablecoin TAM Expansion | ✅ On Track | 2026-07 | Q2'26 流通量数据（8/5） | The Block / DeFiLlama TAM 追踪 |
| 2 | USDC Market Share Stable | ✅ On Track | 2026-07 | 每月 Attestation | Circle Monthly Report |
| 3 | CPN Scaling | 🟡 Early Stage | 2026-07 | Q2'26 CPN 合作伙伴/TPV 披露 | Earnings Call / Press Releases |
| 4 | Arc Commercialization | 🔴 Pre-Revenue | 2026-07 | ARC 主网上线公告 | Circle Blog / GitHub |
| 5 | Regulation Positive | ✅ Confirmed | 2026-07-10 | GENIUS 过渡期细则（2026H2） | Federal Register / OCC |
| 6 | Non-Reserve Revenue Mix Shift | 🟡 Early Traction | 2026-07 | 非储备收入 >10%（触发卖方模型更新） | Quarterly Earnings |

**Scorecard 使用规则**：
- ✅ = 持续验证 → 维持评级
- 🟡 = 需要新数据点 → 主动监控模式
- 🔴 = 偏离 Base Case → 触发 Thesis 重新评估
- ⬛ = 证伪 → 对照 Kill Switch 执行
